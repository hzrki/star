...
namespace msptool
{
    ...
    {
        private static readonly string vloc1 = "1.6.8";
...
";
                        ...
                        while (true)
                        {
                            ...
                            switch (loc13)
                            {
                                ...
                                case "31":
                                    ...
                                    break;
                                case "32":
                                    botGeneratorWithoutLisa(server, culture);
                                    break;
                                case "33":
    ...
    static void botGeneratorWithoutLisa(string server, string culture)
        {
            Console.Clear();
            AnsiConsole.Write(new Rule("[#71d5fb]MSPTOOL[/] ・ Home ・ Bot Generator").LeftJustified()
                .RoundedBorder());

...
namespace msptool
{
    internal class Program
    {
            ...
            while (!loggedIn)
            {
                ...
                else
                {
                    ...
                    while (true)
                    {
                        ...
                        AnsiConsole.Write(
                            new Rule(
                                    "[slowblink][#71d5fb]lucid & 6c0[/][/] ・ [link=https://discord.gg/msp1]discord.gg/msp1[/]")
        ...
        {
            Console.Clear();
            AnsiConsole.Write(new Rule("[#71d5fb]MSPTOOL[/] ・ Home ・ Recycle None-Rare Clothes").LeftJustified()
                .RoundedBorder());
            Console.Write("\n");

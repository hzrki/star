    ...
    public static class localisation
    {
        public static readonly Dictionary<string, Dictionary<int, string>> Msptoolhome = new()
        {
            ...
            ["German"] = new Dictionary<int, string>
            {
                ...
                { 17, "Spieler-Daten anschauen" },
                { 18, "Benutzername überprüfen" },
            ...
            {
                { 1, "Kierrätä ei-harvinaiset vaatteet" },
                { 2, "Osta Boonie" },
                { 3, "Osta animaatioita" },
                { 4, "Osta vaatteita" },
                { 5, "Osta silmät" },
